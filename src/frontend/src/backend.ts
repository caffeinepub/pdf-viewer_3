...
export class Backend implements backendInterface {
    ...
    async clearImages(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearImages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setImages(arg0: Array<ExternalBlob>, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setImages(await to_candid_vec_n12(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Image_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Image): Promise<Image> {
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Image>): Promise<Array<Image>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Image_n9(_uploadFile, _downloadFile, x)));
}
